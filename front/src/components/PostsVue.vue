                ...
                <v-card elevation="8" width="700">
                    <v-img elevation="8" v-if="post.imageUrl" height="400px" :src="post.imageUrl">
                        <v-card-title class="font-weight-light white--text ">
                            ...
                            <v-spacer></v-spacer>
                            <v-app-bar mb-2 flat color="rgba(0, 0, 0, 0)">
                                <v-toolbar-title class="text-subtitle-2 font-weight-light white--text pl-15 mr-n15">{{
                                    ...
                                    <v-list>
                                        <v-list-item>
                                            <v-btn color="primary" class="mx-3" @click="messageToEdit(post)"
                                                v-if="post.UserId == UserId">Editer</v-btn>
                    ...
                    <v-img v-else height="200px" src="">
                        <v-app-bar flat color="rgba(0, 0, 0, 0)">
                            <v-toolbar-title class="text-subtitle-2 white--text pl-0">Posté le : {{
                                    dateParser(post.createdAt)
                            }}</v-toolbar-title>
                            <v-spacer></v-spacer>
                            <v-col cols="2" class="pa-0 d-flex text-center justify-end align-end"
                        ...
                        <v-card-title class="white--text mt-8">
                            ...
                            <p class="ml-3" @click="profil(post.UserId)">{{ post.User.last_name }} {{
                                    post.User.first_name
                            }}</p>
                        </v-card-title>
                    </v-img>
