                            ...
                            <v-row>
                                <v-col classe="cardbox" cols="12" md="8">
                                    <v-card-text class="mt-12">
                                        <h1 class="text-center font-weight-light display-2 black--text ">Groupomania
                                        </h1>

                                        <h4 class="text-center font-weight-light mt-4">Ensure your email for
                                            registration</h4>
                                    ...
                                    <div class="text-center mt-3">
                                        <v-btn class="ma-4 primary" rounded color="white" @click="login()">SIGN IN
                                        </v-btn>
                                    </div>
                                </v-col>
                                <v-col cols="12" md="4" class="pa-5 primary">
                                    <v-card-text class="white--text mt-12">
                                        ...
                                        <h5 class="text-center font-weight-light">Enter your personal details and start
                                            journay with us
                                        </h5>
                                    </v-card-text>
                            ...
                            <v-row class="fill-height">
                                <v-col cols="12" md="4" class="primary">
                                    <v-card-text class="white--text mt-12">
                                        ...
                                        <h5 class="text-center font-weight-light">To Keep connected with us please login
                                            with your
                                            personnel info</h5>
                                    </v-card-text>
                                ...
                                <v-col cols="12" md="8">
                                    <v-card-text class="mt-12">
                                        <h3 class="text-center display-2  font-weight-light text--black">Create Account
                                        </h3>
                                    ...
                                    <div class="text-center mt-n5">
                                        <v-btn :disabled="email && password && last_name && first_name == ''"
                                            @click="register()" class="ma-5 primary--text" rounded color="white"
                                            primary>SIGN UP
                                        </v-btn>
                                    </div>
                                </v-col>
